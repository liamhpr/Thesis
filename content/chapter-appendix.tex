...
https://github.com/liamhpr/Credal-Prediction-for-LLMs.git
...
$\mathcal{T}_\alpha$ with $\alpha \in \{0.6, 0.7, 0.8, 0.9\}$.
\begin{table}[h]
    \centering
...
highlighted in bold. In addition the resulting $\alpha$-cuts
$\mathcal{T}_\alpha$ with $\alpha \in \{0.7, 0.8, 0.9\}$.
\begin{table}[h]
    \centering
    ...
    $|\mathcal{T}_{0.9}| = 11$\\
    $\mathcal{T}_{0.8} = \{ 1.135, \dots, 1.686\}$ \quad \quad
    $|\mathcal{T}_{0.8}| = 16$\\
    $\mathcal{T}_{0.7} = \{ 1.061, \dots, 1.759 \}$ \quad \quad
    $|\mathcal{T}_{0.7}| = 20$ \\
    \bottomrule
    \end{tabular}
    \caption{}
