...
deep learning models(PROOF???) designed to process, 
understand, and generate human language. 
At their core, modern LLMs are built upon the 
Transformer architecture 
\cite{NIPS2017_3f5ee243, naveed2024comprehensiveoverviewlargelanguage}, 
...
and coding \cite{tian2023chatgptultimateprogrammingassistant},
...
\cite{NIPS2017_3f5ee243, bahdanau2016neuralmachinetranslationjointly}
...
\cite{bahdanau2016neuralmachinetranslationjointly}
$$P(y | x) = \prod_{t=1}^{T} P(y_t | y_{<t}, x)$$
Where $y_t$ is the token at step $t$ and $y_{<t}$ represents
...
$$P(y_t = v_i | y_{<t}, x) = \frac{exp(z_i)}{\sum_{j \in V} exp(z_j)}$$
