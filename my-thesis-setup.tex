...
% **************************************************
\newcommand{\thesisTitle}{My Thesis Title} % WARNING: CHANGE THIS ON THE FINAL COMMIT
...
\newcommand{\thesisFirstSupervisor}{Eyke H{\"u}llermeier}
\newcommand{\thesisSecondSupervisor}{Paul Hofman}
